...
(function($) {
  ...
  AdGallery.prototype = {
      ...
      var inter = setInterval(
        function() {
          ...
          if(thumb_count == thumbs_loaded) {
            ...
            list.css('height', thumb_wrapper_height +'px');
            var i = 1;
            var last_height = list.height();
            while(i < 201) {
              list.css('height', (thumb_wrapper_height + i) +'px');
     ...
     *                          and it's animation has finished
                HXD: Essentially invoked on clicking the image's a
     */
    ...
    /* HXD: This routine is the one used to move ul around */
    highLightThumb: function(thumb) {
      ...
      if(top>0) top=0;
      if (can_limit_top) {
        var limes = this.nav_display_height-allh;
        if (top<limes) top = limes;
      }
      this.thumbs_wrapper.animate({top: top +'px'}, 200);
      /* HXD STOP */
    },
