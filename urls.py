...
urlpatterns = patterns('trybar',
    ...
    url(r'^promocja/$', 'main.static.birthday'),
    url(r'^promocja$', 'main.static.birthday'),
    ...
    url(r'^profile/events/(?P<page>\d+?)/$', 'barevent.manage_event.list_of_events'),
    url(r'^profile/events/$', 'barevent.manage_event.list_of_events'),
    ...
    url(r'^bar/(?P<slugname>[^/]+?)/(?P<evtname>[^/]+?)/add_photo/$', 'barevent.add_photo.view'),
